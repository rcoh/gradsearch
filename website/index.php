...
<script type="text/javascript" charset="utf-8">
  ...
  if (isset($_SESSION['msg'])) {
   ...
   unset($_SESSION['msg']); 
        ...
        <div class="container">
            <div class="hero-unit" style="text-align:center; background-color:white; margin:20px; padding:10px 30px 40px 30px;">
...
<div style="height:60px"></div>
        ...
        <footer>
            ...
            <p>
              <a href="https://github.com/rcoh/gradsearch">Source</a>
            </p>
        </footer>
    </body>
</html>
